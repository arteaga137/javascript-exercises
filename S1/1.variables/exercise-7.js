...
// precio final = precio base + globalBasePrice

car1.finalPrice = car1.basePrice + globalBasePrice;
car2.finalPrice = car2.basePrice + globalBasePrice;

console.log(`El precio final del primer carro es: ${car1.finalPrice}`);
console.log(`El precio final del primer carro es: ${car2.finalPrice}`);